...
RUNES Analytics Pro é uma plataforma avançada para análise de tokens RUNES no Bitcoin, com foco especial no rastreamento de "baleias" (grandes investidores) e detecção de manipulação de mercado.

## Funcionalidades Principais

### Página Inicial
- Lista de tokens RUNES classificados por volume
- Filtros por diferentes períodos (1h, 24h, 7d, 30d, total)
- Indicadores de atividade de baleias
- Seções de maiores altas, quedas e volume

### Análise Individual de Token
- Gráficos detalhados com múltiplos timeframes
- Análise técnica com indicadores avançados
- Níveis de Fibonacci com suportes e resistências
- Rastreamento de baleias específico para cada token

### Rastreador de Baleias
- Alertas em tempo real de acumulação e distribuição
- Detecção de padrões de manipulação
- Análise de concentração de tokens
- Previsão de movimentos baseada em dados históricos

### Sistema de Favoritos
- Adicione tokens à sua lista de favoritos
- Acesso rápido aos seus tokens preferidos
- Acompanhamento personalizado

## Como Usar

1. **Página Inicial**: Navegue pela lista de tokens e clique em um token para ver análise detalhada
2. **Favoritos**: Clique na estrela ao lado de um token para adicioná-lo aos favoritos
3. **Análise Individual**: Explore os gráficos, indicadores e alertas específicos para o token
4. **Alertas de Baleias**: Fique atento aos alertas de acumulação e distribuição para identificar oportunidades
...
- Rastreamento em tempo real de transações
