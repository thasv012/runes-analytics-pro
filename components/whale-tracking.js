...
class RunesWhaleTracker {
    constructor() {
        ...
        this.minWhaleThreshold = 100000; // Valor mínimo em USD para considerar uma transação de baleia
        this.timeRange = '24h'; // Período padrão
        this.selectedRune = 'ALL'; // Default para todos os RUNES
        this.alertThreshold = 500000; // Valor para emitir alertas especiais (USD)
        this.lastUpdate = null;
    }
    
    /**
     * Inicializa o componente de rastreamento de baleias
     */
    async initialize() {
        console.log('Inicializando componente de rastreamento de baleias...');
        
        // Localizar o container para este componente
        this.container = document.getElementById('whale-tracking-content') || 
                         document.querySelector('.whale-tracking-section-content');
                         
        if (!this.container) {
            console.error('Container para rastreamento de baleias não encontrado');
            return false;
        }
        
        // Renderizar estrutura básica
        this.renderBaseStructure();
        
        // Carregar dados iniciais (mock para demonstração)
        await this.loadWhaleData();
        
        // Configurar event listeners
        this.setupEventListeners();
        
        // Iniciar temporizador para atualizar dados periodicamente
